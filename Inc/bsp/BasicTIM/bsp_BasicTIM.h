...
#define BASIC_TIMx_PERIOD              4200  // 定时器产生中断频率为：1MHz/1000=1KHz，即1ms定时周期

// 最终定时器频率计算为： 84MHz/（BASIC_TIMx_PRESCALER+1）/BASIC_TIMx_PERIOD
// 比如需要产生20ms周期定时，可以设置为： 84MHz/（83+1）/1000=1Hz，即1ms周期
// 这里设置 BASIC_TIMx_PRESCALER=83；BASIC_TIMx_PERIOD=1000；
