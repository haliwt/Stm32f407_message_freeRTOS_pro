...
#define FLASH_SPIx                                 SPI1 //WT.EDIT //SPI2
#define FLASH_SPIx_RCC_CLK_ENABLE()                __HAL_RCC_SPI1_CLK_ENABLE()
#define FLASH_SPIx_RCC_CLK_DISABLE()               __HAL_RCC_SPI1_CLK_DISABLE()

#define FLASH_SPI_GPIO_ClK_ENABLE()                {__HAL_RCC_GPIOB_CLK_ENABLE();__HAL_RCC_GPIOB_CLK_ENABLE();} 
#define FLASH_SPI_GPIO_PORT                        GPIOB //WT.EDIT
#define FLASH_SPI_SCK_PIN                          GPIO_PIN_3

#define FLASH_SPI_MOSI_PIN                         GPIO_PIN_5  //WT.EDIT PB5=MOSI
...
#define FLASH_SPI_MISO_PORT                        GPIOB //WT.EDIT PB4 =MISO
